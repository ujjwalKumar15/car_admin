					...
					<div class="container">
						...
						<div class="checkout-step-process">
							<ul>
								...
								<li>
									<div class="step-process-item active"><i class="step-icon-truck step-icon"></i><span class="text">Shipping Address</Address></span></div>
								</li>
                                <li>
						...
						<form id="shiiping_form" name="checkout" method="POST" class="checkout woocommerce-checkout form-in-checkout" action="/shipping">
                            @csrf
							<ul class="row">
								<li class="col-md-9">
