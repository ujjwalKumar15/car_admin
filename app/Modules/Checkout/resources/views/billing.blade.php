			...
			<div class="main-container col1-layout content-color color">
				...
				<div class="woocommerce">
					<div class="container">
						...
						<form  method="POST" class="checkout woocommerce-checkout form-in-checkout" action="/billing">
                            @csrf
							<ul class="row">
								<li class="col-md-9">
                                    ...
                                    @foreach ($Address_datas as $data )
                                     ...
                                     <span class="form-radio"><input type="radio" name="address" class="address_click"id="rs1" value="{{$data->id}}" checked><label for="get_id" >{{ $data->Address }}</label></span><br>
                                ...
                                <div id="form" class="woocommerce-billing-fields">
									...
									<div>
									<li class="col-md-12 col-left-12 form-radios">
										<span class="form-radio"><input type="radio" name="shipping" value="1" id="rs1"><label for="rs1">Ship to this address</label></span>
