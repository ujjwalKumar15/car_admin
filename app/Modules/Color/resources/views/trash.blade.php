...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <div>
        <a class="btn btn-dark float-right" href="{{ url('list') }}" role="button">BACK
        <i class="fas fa-arrow-alt-circle-left fa-lg"></i></i></a></div>
        </div>
        ...
        <tbody>
           @foreach($colors as $col)
              ...
              <a class="btn btn-danger" href="{{ url('delete',$col->id) }}" role="button">Delete &nbsp;<i class="far fa-trash-alt"></i></a>
